...
<section class="min-h-screen flex flex-col md:flex-row justify-center space-y-10 md:space-y-0 md:space-x-16 items-center my-0 mx-0 md:mx-0 md:my-0 pt-16">
    ...
    <div class="md:w-1/3 max-w-sm ml-16 pb-6">
        <div class="my-8 flex flex-col items-center">
            ...
            <p class="mb-0 mx-auto text-center font-semibold text-slate-500 text-xl">Connexion</p>
        </div>
        <input class="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded" type="text" placeholder="Nom d'utilisateur" />
        <input class="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded mt-4" type="password" placeholder="Mot de passe" />
        <div class="text-center md:text-left">
            <button class="mt-8 bg-blue-600 hover:bg-blue-700 px-6 py-3 text-white uppercase rounded text-sm tracking-wider" type="submit">Connexion</button>
        </div>
    </div>
</section>
</body>
