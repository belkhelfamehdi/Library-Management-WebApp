...
<%@ page import="com.bibliotheque.PenalisationBean" %>
...
<div class="mt-14 px-4 my-4 sm:px-8 flex-1 overflow-hidden ml-64 p-4">
    <div class="py-8">
        <div>
            <h2 class="text-2xl font-semibold leading-tight">Les sanctions</h2>
        </div>
        <div class="my-2 flex sm:flex-row flex-col">
            ...
            <div class="block relative">
                ...
                <input id="searchInput" oninput="livePenaliserSearch()" placeholder="Search"
            ...
            <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                <table class="min-w-full leading-normal">
                    ...
                    <tr>
                        ...
                        <th
                                class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                            Date de penalisation
                        </th>
                        <th
                                class="px-5 py-3 border-b-2 border-gray-200 bg-gray-100 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                            Date de fin penalisation
                        </th>
                    </tr>
                    ...
                    <tr class="border-b border-gray-200">
                        <td class="px-5 py-5 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                                <%= penalisation.getIdAbonnee() %>
                            </p>
                        </td>
                        <td class="px-5 py-5 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap">
                                <%= penalisation.getNomAbonnee() %>
                            </p>
                        </td>
                        <td class="px-5 py-5 bg-white text-sm">
                            <p class="text-gray-900 whitespace-no-wrap"><%= penalisation.getPrenomAbonnee() %></p>
                        </td>
                        <td class="px-5 py-5 bg-white text-sm">
                            <p class="capitalize text-gray-900 whitespace-no-wrap">
                                <%= penalisation.getDebutP() %>
                            </p>
                        </td>
                        <td class="px-5 py-5 bg-white text-sm">
                            <p class="capitalize text-gray-900 whitespace-no-wrap">
                                <%= penalisation.getFinP() %>
                            </p>
                        </td>
                    </tr>
                    <% } %>
